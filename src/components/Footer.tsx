      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>Rua José Nazario Rebello, 21 - Velha Central, Blumenau, SC</li>
              <li>cabralestetica12@gmail.com</li>
              <li>(47) 99753-2495</li>
              <li className="pt-2">
                <a href="https://wa.me/5547997532495" className="bg-green-500 hover:bg-green-600 px-4 py-2 rounded inline-flex items-center mt-2">
